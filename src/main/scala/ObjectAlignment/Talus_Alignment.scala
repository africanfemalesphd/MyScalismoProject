...
object Talus_Alignment {
  def main(args: Array[String])={
    ...
    val referenceMesh = MeshIO.readMesh(new File("data/CT_Images/CT2/CT2_Talus.stl")).get
    val refLmks = LandmarkIO.readLandmarksJson[_3D](new File("data/CT_Images/CT2/CT2_Talus.json")).get
    ...
    val AlignMeshes = (1 until 12).map { i: Int =>
      val mesh: TriangleMesh[_3D] = MeshIO.readMesh(new File("data/Objects/Left/Hindfoot/Talus/initial/triangle-meshes/CT"+i+"_Talus.stl")).get
      //ui.show(targetGroup2, mesh, "Unaligned_FemurMeshes" + i)

      val UnalignedMeshLmks = LandmarkIO.readLandmarksJson[_3D](new File("data/Objects/Left/Hindfoot/Talus/initial/landmarks/CT"+i+"_Talus.json")).get
      ...
      MeshIO.writeMesh(AlignedFemur,new File("data/Objects/Left/Hindfoot/Talus/aligned/triangle-meshes/CT"+i+".stl"))

      LandmarkIO.writeLandmarksJson[_3D](TranslatedPointsToLmks,new File("data/Objects/Left/Hindfoot/Talus/aligned/landmarks/CT"+i+".json"))
