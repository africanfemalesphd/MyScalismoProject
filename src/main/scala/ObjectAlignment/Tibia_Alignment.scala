...
object Tibia_Alignment {
  ...
  def main(args: Array[String]): Unit ={
    ...
    val referenceMesh = MeshIO.readMesh(new File("data/CT_Images/CT2/CT2_Tibia.stl")).get
    val refLmks = LandmarkIO.readLandmarksJson[_3D](new File("data/CT_Images/CT2/CT2_Tibia.json")).get
    ...
    val AlignMeshes = (1 until 12).map { i: Int =>
      val mesh: TriangleMesh[_3D] = MeshIO.readMesh(new File("data/Objects/Left/Shin_Bones/Tibia/initial/triangle-meshes/CT"+i+"_Tibia.stl")).get
      //ui.show(targetGroup2, mesh, "Unaligned_FemurMeshes" + i)

      val UnalignedMeshLmks = LandmarkIO.readLandmarksJson[_3D](new File("data/Objects/Left/Shin_Bones/Tibia/initial/landmarks/CT"+i+"_Tibia.json")).get
      ...
      MeshIO.writeMesh(AlignedFemur,new File("data/Objects/Left/Shin_Bones/Tibia/aligned/triangle-meshes/CT"+i+".stl"))

      LandmarkIO.writeLandmarksJson[_3D](TranslatedPointsToLmks,new File("data/Objects/Left/Shin_Bones/Tibia/aligned/landmarks/CT"+i+".json"))
