...
object Fibula_Alignment {
  def main(args: Array[String])={
    ...
    //val referenceMesh = MeshIO.readMesh(new File("data/Objects/Left/Shin_Bones/Fibula/initial/triangle-meshes/CT1_Fibula.stl")).get
    //val refLmks = LandmarkIO.readLandmarksJson[_3D](new File("data/Objects/Left/Shin_Bones/Fibula/initial/landmarks/CT1_Fibula.json")).get

    val referenceMesh = MeshIO.readMesh(new File("data/CT_Images/CT2/CT2_Fibula.stl")).get
    val refLmks = LandmarkIO.readLandmarksJson[_3D](new File("data/CT_Images/CT2/CT2_Fibula.json")).get
    ...
    val AlignMeshes = (1 until 12).map { i: Int =>
      val mesh: TriangleMesh[_3D] = MeshIO.readMesh(new File("data/Objects/Left/Shin_Bones/Fibula/initial/triangle-meshes/CT"+i+"_Fibula.stl")).get
      //ui.show(targetGroup2, mesh, "Unaligned_FemurMeshes" + i)

      val UnalignedMeshLmks = LandmarkIO.readLandmarksJson[_3D](new File("data/Objects/Left/Shin_Bones/Fibula/initial/landmarks/CT"+i+"_Fibula.json")).get
      ...
      MeshIO.writeMesh(AlignedFemur,new File("data/Objects/Left/Shin_Bones/Fibula/aligned/triangle-meshes/CT"+i+".stl"))

      LandmarkIO.writeLandmarksJson[_3D](TranslatedPointsToLmks,new File("data/Objects/Left/Shin_Bones/Fibula/aligned/landmarks/CT"+i+".json"))
      //LandmarkIO.writeLandmarksJson[_3D](TranslatedPointsToLmks,new File("data/Objects/Left/Shin_Bones/Fibula/aligned/landmarks/CT"+i+".csv"))
