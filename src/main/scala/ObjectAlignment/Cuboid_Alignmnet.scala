...
object Cuboid_Alignmnet {
  def main(args: Array[String])={
    ...
    val referenceMesh = MeshIO.readMesh(new File("data/Objects/Left/Midfoot/Cuboid/initial/triangle-meshes/CT2_Cuboid.stl")).get
    val refLmks = LandmarkIO.readLandmarksJson[_3D](new File("data/Objects/Left/Midfoot/Cuboid/initial/landmarks/CT2_Cuboid.json")).get
    ...
    val AlignMeshes = (1 until 12).map { i: Int =>
      val mesh: TriangleMesh[_3D] = MeshIO.readMesh(new File("data/Objects/Left/Midfoot/Cuboid/initial/triangle-meshes/CT"+i+"_Cuboid.stl")).get
      //ui.show(targetGroup2, mesh, "Unaligned_FemurMeshes" + i)

      val UnalignedMeshLmks = LandmarkIO.readLandmarksJson[_3D](new File("data/Objects/Left/Midfoot/Cuboid/initial/landmarks/CT"+i+"_Cuboid.json")).get
      ...
      MeshIO.writeMesh(AlignedFemur,new File("data/Objects/Left/Midfoot/Cuboid/aligned/triangle-meshes/CT"+i+".stl"))

      LandmarkIO.writeLandmarksJson[_3D](TranslatedPointsToLmks,new File("data/Objects/Left/Midfoot/Cuboid/aligned/landmarks/CT"+i+".json"))
